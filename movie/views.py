...
def createreview(request, movie_id):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'createreview.html', {'from':ReviewForm(), 'error':'bad data passed in.'})
@login_required
def updatereview(request, review_id):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'updatereview.html', {'review':review, 'error': 'Bad data in from.'})
@login_required
